...
public class PensionerController {
	...
	@PostMapping("/upload")
	  ...
	  public ResponseEntity<List<Pensioner>> getAllTutorials() {
	    try {
	      List<Pensioner> tutorials = pensionerServviceImpl.getAllPensioners();
	...
	Pensioner createpensioner(@RequestBody Pensioner pensioner) {
		Pensioner createpensioner = pensionerServviceImpl.pensionerdetails(pensioner);
	...
	ResponseEntity<String> getPensioner(@PathVariable("aadhaarnumber") long aadhaarnumber) {
		...
		Pensioner pensi = pensionerServviceImpl.getPensionerById(aadhaarnumber);
